...
fun Long.timeFormat(pattern: String = "yyyy-MM-dd HH:mm:ss"): String = SimpleDateFormat(pattern, Locale.ENGLISH).format(this)

fun Long.dateFormat(pattern: String = "yyyy-MM-dd"): String = SimpleDateFormat(pattern, Locale.ENGLISH).format(this)
